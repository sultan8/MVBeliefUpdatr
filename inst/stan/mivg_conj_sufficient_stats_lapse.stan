...
Exposure inputs for each exposure group are in the form of sufficient statistics
for each category (number of observations, mean, and uncentered sum of squares).

Test inputs for each exposure group are in the form of test locations and counts
